...
class ILBERT(nn.Module):
    ...
    def forward(self, input):
        ...
        x1, x2, mol1, mol2,HA1,HD1,HA2,HD2, T, P = input
        ...
        output = torch.cat([mixture_features,T.view(-1, 1), P.view(-1, 1)], dim=1)
        #output = torch.cat([output,T.view(-1, 1)*self.nt, P.view(-1, 1)*self.np], dim=1)
