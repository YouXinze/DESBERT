...
class ILBERT(nn.Module):
    ...
    def forward(self, input):
        ...
        x1, x2, mol1, mol2,HA1,HD1,HA2,HD2 = input
        HA1 = HA1*mol1
        HD1 = HD1*mol1
        HA2 = HA2*mol2
        HD2 = HD2*mol2
        ...
        mixture_feature = self.CNN(last_hidden_states)
        #mixture_feature = torch.cat((mixture_feature, last_hidden_states[0,:,:]),dim=1)
        output = self.pred_head(mixture_feature)
